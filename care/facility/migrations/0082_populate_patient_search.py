...
def populate_patient_search(apps, *args, **kwargs):
    ...
    for patient in patient_qs:
        patient.year_of_birth = (patient.date_of_birth.year
                                 if patient.date_of_birth is not None else
                                 datetime.datetime.now().year - patient.age)
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(populate_patient_search,
                             reverse_code=reverse_populate_patient_search)
    ]
