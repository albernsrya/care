...
def change_recovery_to_recovered(apps, schema_editor):
    ...
    PatientRegistration.objects.filter(
        disease_status=DiseaseStatusEnum.RECOVERY.value).update(
            disease_status=DiseaseStatusEnum.RECOVERED.value)
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(change_recovery_to_recovered,
