...
class FacilityCreationForm(ModelForm):
    class Meta:
        model = Facility
        fields = [
            "name", "district", "address", "oxygen_capacity", "phone_number"
        ]
        labels = {
            "name":
            ...
            "phone_number":
            "Enter emergency contact number of your hospital",
            "oxygen_capacity":
            "Enter the total oxygen capacity of your hospital (in litres)",
        }
