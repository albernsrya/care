...
class DistrictFilterSet(filters.FilterSet):
    ...
    district_name = filters.CharFilter(field_name="name",
                                       lookup_expr="icontains")
...
class LocalBodyFilterSet(filters.FilterSet):
    ...
    state_name = filters.CharFilter(field_name="district__state__name",
                                    lookup_expr="icontains")
    district = filters.NumberFilter(field_name="district_id")
    district_name = filters.CharFilter(field_name="district__name",
                                       lookup_expr="icontains")
    local_body_name = filters.CharFilter(field_name="name",
                                         lookup_expr="icontains")
...
class WardFilterSet(filters.FilterSet):
    ...
    district_name = filters.CharFilter(field_name="local_body__district__name",
                                       lookup_expr="icontains")
